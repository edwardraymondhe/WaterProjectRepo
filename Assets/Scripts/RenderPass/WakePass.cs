...
{
    class WakePass : ScriptableRenderPass
    {
        private const string k_RenderWaterFXTag = "Render Wake";
        private readonly ShaderTagId m_WaterFXShaderTag = new ShaderTagId("Wake");
